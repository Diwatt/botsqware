...
export type WAHAWebhookEventResponse = {
    /**
    ...
    engine: WAHAWebhookEventResponse.engine;
    /**
     * The event is triggered when the event response is received.
     */
    event: WAHAWebhookEventResponse.event;
    payload: EventResponsePayload;
    me?: MeInfo;
    environment: WAHAEnvironment;
};
export namespace WAHAWebhookEventResponse {
    export enum engine {
        WEBJS = 'WEBJS',
        WPP = 'WPP',
        NOWEB = 'NOWEB',
