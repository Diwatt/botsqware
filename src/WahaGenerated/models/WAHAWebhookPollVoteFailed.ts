...
export type WAHAWebhookPollVoteFailed = {
    /**
    ...
    engine: WAHAWebhookPollVoteFailed.engine;
    /**
     ...
     */
    event: WAHAWebhookPollVoteFailed.event;
    payload: PollVotePayload;
    me?: MeInfo;
    environment: WAHAEnvironment;
};
export namespace WAHAWebhookPollVoteFailed {
    export enum engine {
        WEBJS = 'WEBJS',
        WPP = 'WPP',
        NOWEB = 'NOWEB',
