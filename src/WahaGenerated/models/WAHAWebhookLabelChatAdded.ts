...
export type WAHAWebhookLabelChatAdded = {
    /**
    ...
    engine: WAHAWebhookLabelChatAdded.engine;
    /**
     * The event is triggered when a label is added to a chat
     */
    event: WAHAWebhookLabelChatAdded.event;
    payload: LabelChatAssociation;
    me?: MeInfo;
    environment: WAHAEnvironment;
};
export namespace WAHAWebhookLabelChatAdded {
    export enum engine {
        WEBJS = 'WEBJS',
        WPP = 'WPP',
        NOWEB = 'NOWEB',
