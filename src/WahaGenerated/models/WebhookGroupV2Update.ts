...
/* tslint:disable */
/* eslint-disable */
import type { GroupV2UpdateEvent } from './GroupV2UpdateEvent';
import type { MeInfo } from './MeInfo';
import type { WAHAEnvironment } from './WAHAEnvironment';
export type WebhookGroupV2Update = {
    /**
    ...
    engine: WebhookGroupV2Update.engine;
    /**
     * When group info is updated
     */
    event: WebhookGroupV2Update.event;
    payload: GroupV2UpdateEvent;
    me?: MeInfo;
    environment: WAHAEnvironment;
};
export namespace WebhookGroupV2Update {
    export enum engine {
        WEBJS = 'WEBJS',
        WPP = 'WPP',
        NOWEB = 'NOWEB',
