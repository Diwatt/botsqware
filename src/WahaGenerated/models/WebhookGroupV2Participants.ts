...
export type WebhookGroupV2Participants = {
    /**
    ...
    engine: WebhookGroupV2Participants.engine;
    /**
     * When participants changed - join, leave, promote to admin
     */
    event: WebhookGroupV2Participants.event;
    payload: GroupV2ParticipantsEvent;
    me?: MeInfo;
    environment: WAHAEnvironment;
};
export namespace WebhookGroupV2Participants {
    export enum engine {
        WEBJS = 'WEBJS',
        WPP = 'WPP',
        NOWEB = 'NOWEB',
