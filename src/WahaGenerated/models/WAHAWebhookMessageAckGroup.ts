...
import type { WAMessageAckBody } from './WAMessageAckBody';
export type WAHAWebhookMessageAckGroup = {
    /**
    ...
    engine: WAHAWebhookMessageAckGroup.engine;
    /**
     * Receive events when participants in a group read or play messages.
     */
    event: WAHAWebhookMessageAckGroup.event;
    payload: WAMessageAckBody;
    me?: MeInfo;
    environment: WAHAEnvironment;
};
export namespace WAHAWebhookMessageAckGroup {
    export enum engine {
        WEBJS = 'WEBJS',
        WPP = 'WPP',
        NOWEB = 'NOWEB',
