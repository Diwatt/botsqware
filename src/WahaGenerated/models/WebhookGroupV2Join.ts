...
/* tslint:disable */
/* eslint-disable */
import type { GroupV2JoinEvent } from './GroupV2JoinEvent';
import type { MeInfo } from './MeInfo';
import type { WAHAEnvironment } from './WAHAEnvironment';
export type WebhookGroupV2Join = {
    /**
    ...
    engine: WebhookGroupV2Join.engine;
    /**
     * When you joined or were added to a group
     */
    event: WebhookGroupV2Join.event;
    payload: GroupV2JoinEvent;
    me?: MeInfo;
    environment: WAHAEnvironment;
};
export namespace WebhookGroupV2Join {
    export enum engine {
        WEBJS = 'WEBJS',
        WPP = 'WPP',
        NOWEB = 'NOWEB',
