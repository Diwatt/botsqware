...
export type WAHAWebhookEventResponseFailed = {
    /**
    ...
    engine: WAHAWebhookEventResponseFailed.engine;
    /**
     * The event is triggered when the event response is failed to decrypt.
     */
    event: WAHAWebhookEventResponseFailed.event;
    payload: EventResponsePayload;
    me?: MeInfo;
    environment: WAHAEnvironment;
};
export namespace WAHAWebhookEventResponseFailed {
    export enum engine {
        WEBJS = 'WEBJS',
        WPP = 'WPP',
        NOWEB = 'NOWEB',
