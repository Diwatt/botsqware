...
/* tslint:disable */
/* eslint-disable */
import type { EnginePayload } from './EnginePayload';
import type { MeInfo } from './MeInfo';
import type { WAHAEnvironment } from './WAHAEnvironment';
export type WAHAWebhookEngineEvent = {
    /**
    ...
    engine: WAHAWebhookEngineEvent.engine;
    /**
     * Internal engine event.
     */
    event: WAHAWebhookEngineEvent.event;
    payload: EnginePayload;
    me?: MeInfo;
    environment: WAHAEnvironment;
};
export namespace WAHAWebhookEngineEvent {
    export enum engine {
        WEBJS = 'WEBJS',
        WPP = 'WPP',
        NOWEB = 'NOWEB',
