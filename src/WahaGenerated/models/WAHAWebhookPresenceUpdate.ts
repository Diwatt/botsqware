...
import type { WAHAChatPresences } from './WAHAChatPresences';
import type { WAHAEnvironment } from './WAHAEnvironment';
export type WAHAWebhookPresenceUpdate = {
    /**
    ...
    engine: WAHAWebhookPresenceUpdate.engine;
    /**
     * The most recent presence information for a chat.
     */
    event: WAHAWebhookPresenceUpdate.event;
    payload: WAHAChatPresences;
    me?: MeInfo;
    environment: WAHAEnvironment;
};
export namespace WAHAWebhookPresenceUpdate {
    export enum engine {
        WEBJS = 'WEBJS',
        WPP = 'WPP',
        NOWEB = 'NOWEB',
