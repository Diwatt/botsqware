...
/* tslint:disable */
/* eslint-disable */
import type { GroupV2LeaveEvent } from './GroupV2LeaveEvent';
import type { MeInfo } from './MeInfo';
import type { WAHAEnvironment } from './WAHAEnvironment';
export type WebhookGroupV2Leave = {
    /**
    ...
    engine: WebhookGroupV2Leave.engine;
    /**
     * When you left or were removed from a group
     */
    event: WebhookGroupV2Leave.event;
    payload: GroupV2LeaveEvent;
    me?: MeInfo;
    environment: WAHAEnvironment;
};
export namespace WebhookGroupV2Leave {
    export enum engine {
        WEBJS = 'WEBJS',
        WPP = 'WPP',
        NOWEB = 'NOWEB',
