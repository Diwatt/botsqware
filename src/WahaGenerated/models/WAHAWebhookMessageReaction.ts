...
import type { WAMessageReaction } from './WAMessageReaction';
export type WAHAWebhookMessageReaction = {
    /**
    ...
    engine: WAHAWebhookMessageReaction.engine;
    /**
     * The event is triggered when a user reacts or removes a reaction.
     */
    event: WAHAWebhookMessageReaction.event;
    payload: WAMessageReaction;
    me?: MeInfo;
    environment: WAHAEnvironment;
};
export namespace WAHAWebhookMessageReaction {
    export enum engine {
        WEBJS = 'WEBJS',
        WPP = 'WPP',
        NOWEB = 'NOWEB',
