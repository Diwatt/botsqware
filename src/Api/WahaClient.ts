...
export class HttpClient<SecurityDataType = unknown> {
  public baseUrl: string = "{protocol}://{host}:{port}/{baseUrl}";
 ...
 * @externalDocs https://waha.devlike.pro/
 * @contact
 *
...
> extends HttpClient<SecurityDataType> {
  api = {
    ...
    mediaControllerConvertVoice: (
      ...
      this.request<File, any>({
        path: `/api/${session}/media/convert/voice`,
        method: "POST",
        body: data,
        secure: true,
        type: ContentType.Json,
    ...
    mediaControllerConvertVideo: (
      ...
      this.request<File, any>({
        path: `/api/${session}/media/convert/video`,
        method: "POST",
        body: data,
        secure: true,
        type: ContentType.Json,
